...
#SBATCH --output=logs/FoundationModel_ViT-H_p16_b2048_PatchReg_benchmark_%j.out  # Single output file
#SBATCH --error=logs/FoundationModel_ViT-H_p16_b2048_PatchReg_benchmark_%j.err   # Single error file
...
CHECKPOINT_DIR="/data1/vanderbc/nandas1/FoundationModel_ViT-H_p16_b2048_PatchReg/logs"
OUTPUT_DIR="/data1/vanderbc/nandas1/PostProc_FoundationModels/benchmark_results/FoundationModel_ViT-H_p16_b2048_PatchReg"
...
# Model parameters
FEATURE_DIM=1280            # Feature dimension (depends on ViT type: 768 for ViT-S, 1024 for ViT-B, etc.)
