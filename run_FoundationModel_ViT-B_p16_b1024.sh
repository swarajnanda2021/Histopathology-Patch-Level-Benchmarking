...
#SBATCH --output=logs/FoundationModel_ViT-B_p16_b1024_benchmark_%j.out  # Single output file
#SBATCH --error=logs/FoundationModel_ViT-B_p16_b1024_benchmark_%j.err   # Single error file
...
CHECKPOINT_DIR="/data1/vanderbc/nandas1/FoundationModel_ViT-B_p16_b1024/logs"
OUTPUT_DIR="/data1/vanderbc/nandas1/PostProc_FoundationModels/benchmark_results/FoundationModel_ViT-B_p16_b1024"
