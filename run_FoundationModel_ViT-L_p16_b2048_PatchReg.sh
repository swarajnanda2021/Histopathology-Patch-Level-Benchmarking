...
#SBATCH --output=logs/FoundationModel_ViT-L_p16_b2048_PatchReg_benchmark_%j.out  # Single output file
#SBATCH --error=logs/FoundationModel_ViT-L_p16_b2048_PatchReg_benchmark_%j.err   # Single error file
#SBATCH --partition=gpu            # Your specific partition
#SBATCH --signal=USR2@120          # Signal before time limit
#SBATCH --time=2-12:00:00          # Request 2 days
...
CHECKPOINT_DIR="/data1/vanderbc/nandas1/FoundationModel_ViT-L_p16_b2048_PatchReg/logs"
OUTPUT_DIR="/data1/vanderbc/nandas1/PostProc_FoundationModels/benchmark_results/FoundationModel_ViT-L_p16_b2048_PatchReg"
...
INCLUDE_FINAL=False        # Include the final checkpoint

# Model parameters
FEATURE_DIM=1024            # Feature dimension (depends on ViT type: 768 for ViT-S, 1024 for ViT-B, etc.)
