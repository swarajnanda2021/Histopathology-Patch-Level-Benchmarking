...
#SBATCH --output=logs/FoundationModel_ViT-B_p16_b1024_PatchReg_benchmark_%j.out  # Single output file
#SBATCH --error=logs/FoundationModel_ViT-B_p16_b1024_PatchReg_benchmark_%j.err   # Single error file
#SBATCH --partition=gpu            # Your specific partition
#SBATCH --signal=USR2@120          # Signal before time limit
#SBATCH --time=5-00:00:00          # Request 2 days
...
CHECKPOINT_DIR="/data1/vanderbc/nandas1/FoundationModel_ViT-B_p16_b1024_PatchReg/logs"
OUTPUT_DIR="/data1/vanderbc/nandas1/PostProc_FoundationModels/benchmark_results/FoundationModel_ViT-B_p16_b1024_PatchReg"
